...
@Component({
  ...
  templateUrl: './add-wedding-user.component.html',
  styleUrl: './add-wedding-user.component.scss'
})
export class AddWeddingUserComponent implements OnInit {
