...
export class SettingComponent implements OnInit {
  ...
  constructor(
   ...
   ngOnInit(): void {
    ...
    this.loadWeddingAccess();
    this.loadWeddingDays();
    this.loadWeddingServices();
  ...
  loadMemberAccess(){
    this.weddingService.getAllWeddingMemberType(this.weddingId)
    .subscribe(
      (data: any) => {
    ...
    loadWeddingDays(){
    this.weddingService.getAllWeddingDays(this.weddingId)
    .subscribe(
      (data: any) => {
        this.weddingDays = data.data;
        console.log("weddingDays",this.weddingDays);
      },
      error => {
        console.error('Error fetching users:', error);
      }
  ...
  loadWeddingAccess()
  {
    this.weddingService.getAllWeddingAccessType(this.weddingId)
    .subscribe(
      (data: any) => {
  ...
  loadWeddingServices(){
    this.weddingService.getAllWeddingServices(this.weddingId)
    .subscribe(
      (data: any) => {
        this.weddingServices = data.data;
        console.log("weddingServices",this.weddingServices);
      },
      error => {
        console.error('Error fetching users:', error);
      }
  ...
  submitAccess(memberId: number) {
    ...
    this.weddingService.createMemberAccess(payload).subscribe(
      (res: any) => {
  ...
  getAllAccess()
  {
    this.weddingService.getSelectedAccessList(this.weddingId).subscribe(
      (res: any) => {
        // this.toastr.success('Access Provided successfully.', 'Success');
  ...
  removeMemberType(memberId: string)
  {
    ...
    this.weddingService.deleteMemberType(memberId).subscribe(
      (res: any) => {
  ...
  removeAccessType(memberId: string)
  {
    ...
    this.weddingService.deleteAccessType(memberId).subscribe(
      (res: any) => {
  ...
  updateEntryFees(member: any) {
    ...
    this.weddingService.updateEntryFees(payload,this.weddingId).subscribe({
...
const payload = {
  ...
  console.log("payload ->", payload);
      ...
      this.weddingService.assignDayServiceToMember(payload).subscribe(
      (res: any) => {
